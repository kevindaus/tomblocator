...
<html lang="en">
  <head>
    ...
    <!-- The fav and touch icons -->
     <link rel="shortcut icon" href="<?php echo $baseUrl;?>/images/icons/57.png"> 
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="<?php echo $baseUrl;?>/images/icons/144.png">
