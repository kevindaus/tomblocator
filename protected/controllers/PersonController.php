...
class PersonController extends Controller
{
	...
	public function actionDelete($id)
	{
		...
		if (Yii::app()->request->isPostRequest) {
			$currentPassword = $_POST['confirmation_password'];
			$criteria = new CDbCriteria;
			$criteria->compare("username",$userModel->username);
			$criteria->compare("password",md5($currentPassword));
			if (User::model()->exists($criteria)) {
				$this->loadModel($id)->delete();
				Yii::app()->user->setFlash("success","Person record deleted");
			}else{
	...
	public function actionIndex()
	{
		...
		$this->redirect(array('person/admin'));
